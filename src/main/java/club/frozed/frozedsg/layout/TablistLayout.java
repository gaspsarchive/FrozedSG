...
public class TablistLayout implements ZigguratAdapter
{
    ...
    public Set<BufferedTabObject> getSlots(final Player player) {
        final Set<BufferedTabObject> objects = new HashSet<BufferedTabObject>();
        ...
        if (gameManager.getGameState() == GameState.LOBBY) {
            ...
            objects.add(new BufferedTabObject().slot(3).text(this.replace(PotSG.getInstance().getConfiguration("tablist").getString("isInLobby.you"), player)));
            objects.add(new BufferedTabObject().slot(4).text(this.replace(PotSG.getInstance().getConfiguration("tablist").getString("isInLobby.yourName"), player)));
            objects.add(new BufferedTabObject().slot(23).text(PotSG.getInstance().getConfiguration("tablist").getString("isInLobby.server")));
            objects.add(new BufferedTabObject().slot(24).text(this.replace(PotSG.getInstance().getConfiguration("tablist").getString("isInLobby.serverName"), player)));
            objects.add(new BufferedTabObject().slot(43).text(PotSG.getInstance().getConfiguration("tablist").getString("isInLobby.state")));
            objects.add(new BufferedTabObject().slot(44).text(this.replace(PotSG.getInstance().getConfiguration("tablist").getString("isInLobby.playersAmount"), player)));
            objects.add(new BufferedTabObject().slot(45).text(this.replace(PotSG.getInstance().getConfiguration("tablist").getString("isInLobby.maxPlayersAmount"), player)));
            objects.add(new BufferedTabObject().slot(46).text(this.replace(PotSG.getInstance().getConfiguration("tablist").getString("isInLobby.requiredPlayers"), player)));
            ...
            objects.add(new BufferedTabObject().slot(52).text(this.replace(PotSG.getInstance().getConfiguration("tablist").getString("isInLobby.killsAmount"), player)));
            objects.add(new BufferedTabObject().slot(53).text(this.replace(PotSG.getInstance().getConfiguration("tablist").getString("isInLobby.deathsAmount"), player)));
            objects.add(new BufferedTabObject().slot(54).text(this.replace(PotSG.getInstance().getConfiguration("tablist").getString("isInLobby.KDRAmount"), player)));
            objects.add(new BufferedTabObject().slot(55).text(this.replace(PotSG.getInstance().getConfiguration("tablist").getString("isInLobby.winsAmount"), player)));
        ...
        if (gameManager.getGameState() == GameState.PREMATCH || gameManager.getGameState() == GameState.INGAME || gameManager.getGameState() == GameState.ENDING) {
            ...
            objects.add(new BufferedTabObject().slot(4).text(this.replace(PotSG.getInstance().getConfiguration("tablist").getString("isInMatch.ingameAmount"), player)));
            objects.add(new BufferedTabObject().slot(23).text(PotSG.getInstance().getConfiguration("tablist").getString("isInMatch.server")));
            objects.add(new BufferedTabObject().slot(24).text(this.replace(PotSG.getInstance().getConfiguration("tablist").getString("isInMatch.serverName"), player)));
            ...
            objects.add(new BufferedTabObject().slot(44).text(this.replace(PotSG.getInstance().getConfiguration("tablist").getString("isInMatch.spectatorsAmount"), player)));
            int playerSlot = 6;
    ...
    public String replace(final String string, final Player player) {
        ...
        final GameManager gameManager = GameManager.getInstance();
        final PlayerManager playerManager = PlayerManager.getInstance();
        return string.replaceAll("<playerName>", player.getName()).replaceAll("<server_name>", gameManager.getServerName()).replaceAll("<max_players>", String.valueOf(gameManager.getMaxPlayers())).replaceAll("<require_players>", String.valueOf(gameManager.getRequiredPlayersToJoin())).replaceAll("<countdown_players>", String.valueOf(playerManager.getLobbyPlayers().size())).replaceAll("<prematch_players_size>", String.valueOf(playerManager.getPrematchPlayers().size())).replaceAll("<game_players>", String.valueOf(playerManager.getGamePlayers().size())).replaceAll("<spectators_size>", String.valueOf(playerManager.getSpectatorPlayers().size())).replaceAll("<playerKills>", String.valueOf(data.getKills().getAmount())).replaceAll("<playerDeaths>", String.valueOf(data.getDeaths().getAmount())).replaceAll("<playerKDR>", String.valueOf(data.getKdr())).replaceAll("<playerWins>", String.valueOf(data.getWins().getAmount()));
    }
}
